...
| Linux Control Panel | `ce32231f8327e4354c77e1a228fadc231abd6ea7` | `linux-control-panel` | Aero7 fork with native NetworkManager, account, appearance, PipeWire/PulseAudio and UPower workflows, UFW logging controls, Network Management and spelling integration; Wallet support is intentionally excluded |
