...
| execbin | `6127849ad534b07d44b278b14f2246cf43ada3b9` | `execbin` | Full build, staged install, and startup pass with the original Aero7 companion emblem replacing both bundled icons |
| LinVer | `087f2746703d9c885de2e1a4f6360314283703f4` | `linver` | Full qmake build and startup pass with every bundled version-branding resource replaced by the Aero7 companion emblem |
