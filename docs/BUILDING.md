...
If compilation finishes but signing or validation is interrupted, rerun
...
Leave `final_release_confirmation` blank for every development and bug-test
build. Package promotion is reserved for the separately approved final release.
